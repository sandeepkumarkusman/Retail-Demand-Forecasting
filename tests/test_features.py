...
import pandas as pd
import pytest
from src.features import prepare_ml_data, expand_ml_date_features, add_lag_and_rolling_features, add_target_encoding
...
def test_cyclical_encodings():
    ...
    for sin_col, cos_col in [('month_sin', 'month_cos'), ('dow_sin', 'dow_cos'), ('doy_sin', 'doy_cos')]:
